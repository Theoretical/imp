...
class Job(object):
    ...
    def __init__(self, interval, func, single=False, **kwargs):
        """Initialize Job.
        Args:
    ...
    def __str__(self):
        ...
        """
        iso_time = str(datetime.date.fromtimestamp(self.next_time))
        return "<Job(%s, %ss, %s)>" % \
